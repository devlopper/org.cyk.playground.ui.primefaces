...
public class AllInputs {
	...
	@Input @InputManyAutoComplete private Country inputChoiceManyAutoComplete;
	@Input @InputManyButton private Country inputChoiceManyButton;
	@Input @InputManyCheck private Country inputChoiceManyCheck;
	@Input @InputManyCombo private Country inputChoiceManyCombo;
